...
import OCTraN.data.semantic_kitti.io_data as SemanticKittiIO
...
# @hydra.main(config_name="../../config/OCTraN.yaml")
...
def main():
    ...
    kitti_root = "/OCTraN/dataset/semantic_kitti/data_odometry_voxels"
    kitti_preprocess_root = "/OCTraN/dataset/semantic_kitti/preprocess"
