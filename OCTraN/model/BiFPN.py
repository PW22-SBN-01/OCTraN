# https://github.com/ViswanathaReddyGajjala/EfficientDet-Pytorch/blob/master/BiFPN.py
...
fpn = BiFPN([1280, 1280, 1280, 1280, 1280])

c1 = torch.randn([2, 1280, 7, 7])
c2 = torch.randn([2, 1280, 7, 7])
c3 = torch.randn([2, 1280, 7, 7])
c4 = torch.randn([2, 1280, 7, 7])
c5 = torch.randn([2, 1280, 7, 7])
